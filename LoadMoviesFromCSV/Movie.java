...
public class Movie {
    ...
    public Movie (String anID, String aTitle, String aYear, String aCountry, String theGenres, 
    String aDirector, int theMinutes, String aPoster) {
        // just in case data file contains extra whitespace
        id = anID.trim();
        title = aTitle.trim();
        year = Integer.parseInt(aYear.trim());
    ...
    public String toString2 () {
        String result = "Movie [id=" + id + ", title=" + title + ", year=" + year +
       ", country= " + country + ", genres= " + genres + ", director= " + director +
        ", minutes= " + minutes + "]";
        return result;
    }
}
